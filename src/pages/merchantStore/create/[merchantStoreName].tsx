...
const CreateMerchantStore = () => {
  ...
  const [productData0, setProductData0] = useState<{ name: string; description: string; price: string }>({ name: "", description: "", price: "" });
  const [productImg1, setProductImg1] = useState<File | null>(null);
  const [productData1, setProductData1] = useState<{ name: string; description: string; price: string }>({ name: "", description: "", price: "" });
  const [productImg2, setProductImg2] = useState<File | null>(null);
  const [productData2, setProductData2] = useState<{ name: string; description: string; price: string }>({ name: "", description: "", price: "" });
    ...
    <div>
      ...
      <div className="bg-black text-white p-6 border-red-400 border-2">
        ...
        <input
          ...
          onChange={(e) => {
            setProductData0({ ...productData0, [e.target.name]: e.target.value });
          }}
        />
        <input
          type="text"
      ...
      <div className="bg-black text-white p-6 border-red-400 border-2">
        ...
        <input
          ...
          onChange={(e) => {
            setProductData1({ ...productData1, [e.target.name]: e.target.value });
          }}
        />
        <input
          type="text"
      ...
      <div className="bg-black text-white p-6 border-red-400 border-2">
        ...
        <input
          ...
          onChange={(e) => {
            setProductData2({ ...productData2, [e.target.name]: e.target.value });
          }}
        />
        <input
          type="text"
